...
**Watch UI Phase 1.5 SHIPPED 2026-05-25 (kiosk `cef7cbd`, Shannon deploy 00:40 CEST)**:
...
Full HW-decode reasoning + iteration archaeology + the diagnose-first plan: `~/dotfiles/docs/shannon_kiosk_gpu_hwaccel_research_2026_05_18.md` § 6 + `~/dotfiles/docs/reflections/2026-05-25-shannon-hw-decode-archaeology.md` (595 lines, every attempt named) + `~/dotfiles/docs/reflections/2026-05-25-rkvdec-detile-bypass-research.md` (why detile bypass alone didn't fix CPU) + `~/dotfiles/docs/reflections/2026-05-25-hw-decode-research.md`.
